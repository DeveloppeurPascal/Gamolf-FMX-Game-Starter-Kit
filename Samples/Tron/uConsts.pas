...
///
/// ***************************************************************************
/// File last update : 2024-08-20T10:12:34.000+02:00
/// Signature : 6d43c47afd3e8077cd4cd0cda1a9f5197c47ba5f
/// ***************************************************************************
/// </summary>
...
const
  ...
  /// </summary>
  CAboutGameTitle = 'Tron Game Sample';
...
{$ENDIF}
  ...
  /// The real paths are calculated automatically depending on the platform.
  /// </remarks>
  CGameFolderName = 'StarterKitTronSample';
  ...
  /// </summary>
  CGameGUID = '{75459C50-0F7C-474C-B158-28ADA9F8A96A}';
...
{$SCOPEDENUMS ON}
  ...
  TSceneType = (None (* "None" must stay *) , Exit (* "Exit" must stay *) ,
    Home, Game, GameOver, Credits, NbPlayersChoice, ControlsChoice,
    SplashScreen);
